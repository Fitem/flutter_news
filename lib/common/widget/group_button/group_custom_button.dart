...
class GroupCustomButton extends StatelessWidget {
  ...
  Color? _getBackgroundColor(ThemeData theme) {
    ...
    Color? selectedColorBuffer = selectedColor ?? themePrimaryColor;
    Color? unselectedColorBuffer = unselectedColor ?? themeSecondaryColor;
    Color? disabledColorBuffer = disabledColor;
  ...
  OutlinedBorder? _buildShape() {
    ...
    if (borderRadius != null && color != null) {
