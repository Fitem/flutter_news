...
import 'package:flutter_news/common/widget/group_button/group_button_body.dart';
...
class GroupButton extends StatelessWidget {
  GroupButton({
    ...
    this.disabledTextStyle = _kDefaultSelectedTextStyle,
    this.selectedColor,
  ...
  /// [TextStyle] of text of disabled buttons
  ...
  /// [BorderRadiusGeometry] of  buttons
  ...
  final GlobalKey<GroupButtonBodyState> _globalKey = GlobalKey();
